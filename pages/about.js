export default function About() {
  return (
    <>
      <section className="text-zinc-600 dark:text-zinc-300" id="FAQ">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">
              <b className=" text-pink-400">
                I don&apos;t know anything about Blockchain or NFTs. How do I
                start?
              </b>
              <br />
            ...
            <p className="mb-8 leading-relaxed" id="faq">
              <b className=" text-pink-400">
                So all the data I share are written to the blockchain?
              </b>
              <br />
              ...
              is not stored on our servers. This also means that we can&apos;t
              edit the data in future (which is both good and bad).
            </p>
            <p className="mb-8 leading-relaxed">
              <b className=" text-pink-400">
                There will be a lot of fake accounts right?
              </b>{" "}
              <br />
              ...
              to a wallet. Also, we deny &apos;login&apos; to anyone who posted
              the fake before, so it is in fact way easier to create a fake
              profile on any job portal.
            </p>
          </div>
