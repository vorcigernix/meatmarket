          ...
          <div className="md:shrink-0">
            ...
            {!fileUrl && (
              <div
                {...getRootProps({
                  className:
                    "h-48 md:h-full md:w-72 bg-gradient-to-tl from-pink-500 to-pink-200 dark:to-pink-900 justify-center items-center text-center p-8  flex flex-col text-white cursor-pointer",
                })}
              >
                <input {...getInputProps()} />
                <svg
          ...
          <div className="p-8 text-base md:text-sm">
            ...
            <div className="flex mt-2  rounded p-4 text-gray-400">
              ...
              <button
                ...
                onClick={(e) => updateFormInput({ ...formInput, price: "0.1" })}
              ></button>
            ...
            fileUrl ? (
              ...
              <button
                onClick={createMarket}
                className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-2 opacity-20 cursor-not-allowed"
              >
                Create Profile
                <svg
                  fill="none"
